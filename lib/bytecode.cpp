...
namespace lisp {
    ...
    {
        throw std::runtime_error("namespace unimplemented");
    }

    template <typename T>
    void writeParam(Bytecode& bc, const T& param)
    {
    ...
    void BytecodeBuilder::visit(ast::If& node)
    {
        ...
        *jumpOffset2 = (data_.size() - 2) - jumpOffset2Loc; // size of the false block
    }
